...
public class MyAdpater extends BaseAdapter {
	...
	public View getView(int pos, View cView, ViewGroup arg2) {
		...
		if(cView == null){
			...
			holder.tv = (TextView)cView.findViewById(R.id.textView);
			holder.img = (ImageView)cView.findViewById(R.id.imageView);
		...
		holder.imgrequest = imageLoader.get(Common.BASE_URL + item.getImgName(),
				ImageLoader.getImageListener(holder.img, R.mipmap.ic_launcher,
